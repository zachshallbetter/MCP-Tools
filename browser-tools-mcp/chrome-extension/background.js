// BrowserTools MCP Background Script
// Add error handling and logging for debugging

console.log('BrowserTools Background Script: Starting...');
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.type === "GET_CURRENT_URL" && message.tabId) {
    getCurrentTabUrl(message.tabId)
      .then((url) => {
        console.log('Background: Returning URL:', url);
        sendResponse({ success: true, url: url });
      })
      .catch((error) => {
        console.error('Background: Error getting URL:', error);
